...
then
    ...
    echo 'alias setp="export https_proxy=http://${hostip}:7890;export http_proxy=http://${hostip}:7890;export all_proxy=socks5://${hostip}:7890;export ALL_PROXY=socks5://${hostip}:7890;"' >> ~/.bashrc
...
then
    ...
    echo 'alias setp="export https_proxy=http://${hostip}:7890;export http_proxy=http://${hostip}:7890;export all_proxy=socks5://${hostip}:7890;export ALL_PROXY=socks5://${hostip}:7890;"' >> ~/.zshrc
